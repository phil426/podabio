...
```bash
cd "/Users/philybarrolaza/.cursor/Local 315"
gh repo create podn-bio --private --source=. --remote=origin --push
```

### Option 2: Using GitHub Website
1. Go to https://github.com/new
2. Repository name: `podn-bio` (or your preferred name)
...
```bash
cd "/Users/philybarrolaza/.cursor/Local 315"
git remote add origin https://github.com/YOUR_USERNAME/podn-bio.git
