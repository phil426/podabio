...
/**
 * Page Editor
 * PodaBio - Edit page content, widgets, and settings
 */
...
if (!$allowLegacy && feature_flag('admin_new_experience')) {
    header('Location: /admin/userdashboard.php?from=legacy');
    exit;
}
    ...
    <style>
        * {
        ...
        .toast-container {
            ...
            display: flex;
            flex-direction: row; /* Horizontal carousel layout */
            gap: 12px;
            pointer-events: none;
        ...
        <div id="tab-support" class="tab-content">
            <div class="support-section">
                ...
                <div class="support-grid">
                    ...
                    <a href="https://github.com/phil426/podabio" class="support-card" target="_blank" rel="noopener noreferrer">
                        <div class="support-icon">
