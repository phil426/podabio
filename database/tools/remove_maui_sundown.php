<?php
/**
 * Remove Maui Sundown Theme from Database
 * This script removes the "Maui Sundown" theme from the themes table
...
try {
    ...
    echo "🗑️  Removing Maui Sundown Theme...\n\n";
    ...
    echo "==========================================\n";
    echo "✅ Maui Sundown theme removal complete!\n";
    echo "   Deleted theme: $themeName (ID: $themeId)\n";
    if ($pageCount > 0) {
