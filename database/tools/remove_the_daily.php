<?php
/**
 * Remove The Daily Theme from Database
 * This script removes the "The Daily" user theme from the themes table
...
try {
    ...
    echo "🗑️  Removing The Daily Theme...\n\n";
    ...
    $themeId = $theme['id'];
    $isUserTheme = ($theme['user_id'] !== null);
    echo "   ✅ Found theme: {$theme['name']} (ID: $themeId, " . ($isUserTheme ? 'User' : 'System') . ")\n";
    
    if (!$isUserTheme) {
        echo "   ⚠️  Warning: This theme is a system theme, not a user theme.\n";
    ...
    echo "==========================================\n";
    echo "✅ The Daily theme removal complete!\n";
    echo "   Deleted theme: $themeName (ID: $themeId)\n";
    if ($pageCount > 0) {
