<?php
/**
 * Replace All Themes with 12 New Comprehensive Themes
 * 8 Gradient-oriented themes + 4 Solid color themes
 * Includes all new theming system features
 */
...
try {
    ...
    echo "🎨 Replacing All Themes with 12 New Comprehensive Themes\n\n";
    
    // Step 1: Delete all existing system themes (where user_id IS NULL)
    ...
    // Step 2: Insert 12 new themes
    echo "Step 2: Creating 12 new themes...\n\n";
    
    // 8 GRADIENT-ORIENTED THEMES
    $gradientThemes = [
        [
        ...
        [
            ...
            'page_background' => 'linear-gradient(135deg, #667eea 0%, #764ba2 50%, #00d4ff 100%)',
            'widget_styles' => [
                'border_width' => 'thick',
        ...
        [
            ...
            'widget_styles' => [
                ...
                'background_color' => 'rgba(245, 250, 247, 0.9)',
                'spacing' => 'comfortable',
                'shape' => 'round'
            ],
        ...
        [
            ...
            'widget_styles' => [
                ...
                'glow_color' => '#ff6b9d',
                'border_color' => 'var(--accent-color)',
                'background_color' => 'rgba(255, 245, 245, 0.9)',
                'spacing' => 'tight',
                'shape' => 'rounded'
            ],
            'spatial_effect' => 'none'
        ...
        [
            ...
            'widget_styles' => [
                ...
                'glow_color' => '#22d3ee',
                'border_color' => 'var(--accent-color)',
                'background_color' => 'rgba(240, 249, 255, 0.9)',
                'spacing' => 'comfortable',
                'shape' => 'round'
            ],
            'spatial_effect' => 'depth'
    ...
    foreach ($allThemes as $theme) {
        try {
            ...
            echo "   Background: " . (strpos($theme['page_background'], 'gradient') !== false ? 'Gradient' : 'Solid') . "\n";
    ...
    echo "   - 8 Gradient-oriented themes\n";
    echo "   - 4 Solid color themes\n";
    echo "==========================================\n";
