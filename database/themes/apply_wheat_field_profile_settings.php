<?php
/**
 * Apply Wheat Field theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with goldenrod color
 * - Warm, golden glow
 */
...
echo "==========================================\n";
echo "🌾 Apply Wheat Field Profile Settings\n";
echo "==========================================\n\n";

// Find the Wheat Field theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'Wheat Field' LIMIT 1");
    if (!$theme) {
        echo "❌ Wheat Field theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#DAA520', // Goldenrod
            'profile_image_glow_width' => 21 // Warm, golden glow
        ];
        ...
        echo "   - Glow effect with goldenrod (#DAA520)\n";
