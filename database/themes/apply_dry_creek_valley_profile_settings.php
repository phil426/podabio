<?php
/**
 * Apply Dry Creek Valley theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with wine red color
 * - Elegant, sophisticated glow
 */
...
echo "==========================================\n";
echo "🍷 Apply Dry Creek Valley Profile Settings\n";
echo "==========================================\n\n";

// Find the Dry Creek Valley theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'Dry Creek Valley' LIMIT 1");
    if (!$theme) {
        echo "❌ Dry Creek Valley theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#722F37', // Wine red
            'profile_image_glow_width' => 18 // Elegant glow
        ];
        ...
        echo "   - Glow effect with wine red (#722F37)\n";
        echo "   - Glow width: 18px\n";
        $updated++;
