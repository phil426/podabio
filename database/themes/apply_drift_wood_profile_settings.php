<?php
/**
 * Apply Drift Wood theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with khaki color
 * - Natural, warm glow
 */
...
echo "==========================================\n";
echo "🪵 Apply Drift Wood Profile Settings\n";
echo "==========================================\n\n";

// Find the Drift Wood theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'Drift Wood' LIMIT 1");
    if (!$theme) {
        echo "❌ Drift Wood theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#8B7355', // Khaki
            'profile_image_glow_width' => 20 // Natural, warm glow
        ];
        ...
        echo "   - Glow effect with khaki (#8B7355)\n";
