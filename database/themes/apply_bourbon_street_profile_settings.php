<?php
/**
 * Apply Bourbon Street theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with purple color
 * - Large, vibrant glow for festive look
 */
...
echo "==========================================\n";
echo "🎺 Apply Bourbon Street Profile Settings\n";
echo "==========================================\n\n";

// Find the Bourbon Street theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'Bourbon Street' LIMIT 1");
    if (!$theme) {
        echo "❌ Bourbon Street theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#9B59B6', // Purple
            'profile_image_glow_width' => 20 // Large, vibrant glow
        ];
        ...
        echo "   - Glow effect with purple (#9B59B6)\n";
