<?php
/**
 * Apply White Sand theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with sky blue color
 * - Bright, airy glow
 */
...
echo "==========================================\n";
echo "🏖️ Apply White Sand Profile Settings\n";
echo "==========================================\n\n";

// Find the White Sand theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'White Sand' LIMIT 1");
    if (!$theme) {
        echo "❌ White Sand theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#87CEEB', // Sky blue
            'profile_image_glow_width' => 22 // Bright, airy glow
        ];
        ...
        echo "   - Glow effect with sky blue (#87CEEB)\n";
