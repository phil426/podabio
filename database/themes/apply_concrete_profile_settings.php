<?php
/**
 * Apply Concrete theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with slate gray color
 * - Industrial, bold glow
 */
...
echo "==========================================\n";
echo "🏗️ Apply Concrete Profile Settings\n";
echo "==========================================\n\n";

// Find the Concrete theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'Concrete' LIMIT 1");
    if (!$theme) {
        echo "❌ Concrete theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#708090', // Slate gray
            'profile_image_glow_width' => 21 // Industrial, bold glow
        ];
        ...
        echo "   - Glow effect with slate gray (#708090)\n";
        echo "   - Glow width: 21px\n";
        $updated++;
