<?php
/**
 * Apply My Diary theme profile image settings to all pages using the theme
 * 
 * Settings applied:
 * - Glow effect with light pink color
 * - Soft, intimate glow
 */
...
echo "==========================================\n";
echo "📔 Apply My Diary Profile Settings\n";
echo "==========================================\n\n";

// Find the My Diary theme
try {
    $theme = fetchOne("SELECT id, name FROM themes WHERE name = 'My Diary' LIMIT 1");
    if (!$theme) {
        echo "❌ My Diary theme not found. Please create it first.\n";
        exit(1);
    }
...
foreach ($pages as $page) {
    try {
        ...
        $updateData = [
            ...
            'profile_image_glow_color' => '#FFB6C1', // Light pink
            'profile_image_glow_width' => 20 // Soft, intimate glow
        ];
        ...
        echo "   - Glow effect with light pink (#FFB6C1)\n";
