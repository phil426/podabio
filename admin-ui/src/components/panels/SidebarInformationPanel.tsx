...
import styles from './sidebar-information-panel.module.css';

interface SidebarInformationPanelProps {
...
export function SidebarInformationPanel({ activeColor, activeTab }: SidebarInformationPanelProps): JSX.Element {
