...
import { usePageAppearanceMutation, updatePageThemeId, searchPodcasts, type PodcastSearchResult } from '../../../api/page';
...
export function PodcastThemeGenerator({
  ...
  // Fallback to selected podcast artwork, uploaded image, or initial RSS image if activeImageUrl not set yet
  const rawCoverImageUrl = activeImageUrl || selectedPodcast?.artwork_url || uploadedImageUrl || initialCoverImageUrl;
