      ...
      <div className={styles.previewWrapper}>
        ...
        >
          ...
          <div className={styles.contentWrapper} style={contentWrapperStyle}>
            ...
            {/* Page Title */}
            {page?.podcast_name && (() => {
              // Get effect class from CSS vars (generated by previewRenderer) or from page data
              const effectClass = cssVars['--page-title-effect-class'] || 
                (page?.page_name_effect && page.page_name_effect !== 'none' 
                  ? `page-title-effect-${page.page_name_effect}` 
                  : '');
              return (
              <h1 
