...
import type { AppSidebarTabValue } from '../layout/tab-colors';
import styles from './inspector-drawer.module.css';
...
export function InspectorDrawer({ activeColor, activeTab }: InspectorDrawerProps): JSX.Element {
