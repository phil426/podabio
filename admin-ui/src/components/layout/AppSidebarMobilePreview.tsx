...
import styles from './app-sidebar-mobile-preview.module.css';

interface AppSidebarMobilePreviewProps {
  activeColor: string;
}
...
export function AppSidebarMobilePreview({ activeColor }: AppSidebarMobilePreviewProps): JSX.Element {
