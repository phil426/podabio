...
import { AppSidebarCollapseHandle } from './AppSidebarCollapseHandle';
...
export function AppSidebar({ activeTab, onTabChange, activeColor }: AppSidebarProps): JSX.Element {
