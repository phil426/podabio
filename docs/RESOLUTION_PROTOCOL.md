...
> **"Apply Resolution Protocol to [problem description]"**

The AI will then execute this systematic debugging process autonomously until a solution is found.

## Overview

The Resolution Protocol is a recursive, evidence-based debugging methodology that:
...
**User:** "Apply Resolution Protocol to: API endpoints returning 401 errors"
...
See `RESOLUTION_PROTOCOL_IMPLEMENTATION.md` for the executable algorithm.
