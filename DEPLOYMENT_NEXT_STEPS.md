...
You will be prompted for the SSH password: `?g-2A+mJV&a%KP$`
...
# Enter password when prompted: ?g-2A+mJV&a%KP$
```
...
# Or manually:
mysql -h srv775.hstgr.io -u u925957603_pab -p'?g-2A+mJV&a%KP$' u925957603_podabio < database/schema.sql
```
