    ...
    <div class="preview-container">
        ...
        <div class="iphone-frame">
            <div class="iphone-screen">
                ...
                <style>
                    .iphone-screen #page-background-image {
                        position: absolute;
                        top: 0;
                        left: 0;
                        width: 100%;
                    ...
                    .iphone-screen #page-background-image::before {
                        content: '';
                        position: absolute;
                        inset: 0;
                    ...
                    .iphone-screen #page-background-image::after {
                        content: '';
                        position: absolute;
                        inset: 0;
                            ...
                            <div class="profile-header">
                                ...
                                <?php elseif ($page['username']):
                                    ...
                                    <h1 class="page-title <?php echo $effectClass; ?>"
                                        style="font-family: var(--font-family-heading, inherit);">
                                        <?php echo h($page['username']); ?></h1>
                                <?php endif; ?>
                            ...
                            elseif (!empty($links)):
                                foreach ($links as $link): ?>
                                    <a href="/click.php?link_id=<?php echo $link['id']; ?>&page_id=<?php echo $page['id']; ?>"
                                        class="widget-item" target="_blank" rel="noopener noreferrer">
                            ...
                            <footer class="page-footer"
                                ...
                                <?php if (!empty($page['footer_text'])): ?>
                                    <p
                                        ...
                                        <?php echo nl2br(h($page['footer_text'])); ?></p>
                                <?php endif; ?>
                                <div
        ...
        <?php if ($showPodcastPlayer): ?>
            <div class="iphone-frame iphone-podcast-frame">
                <div class="iphone-screen">
                    <div class="iphone-content">
                        <div class="podcast-top-drawer" id="podcast-top-drawer-preview"
                            ...
                            <nav class="tab-navigation" id="tab-navigation-preview">
                                <button class="tab-button active" data-tab="now-playing" id="tab-now-playing-preview">Now
                                    Playing</button>
                            ...
                            <div class="tab-content-container" id="tab-content-container-preview"
                                    ...
                                    <div class="now-playing-content">
                                        ...
                                        <div class="episode-artwork-fullwidth" id="now-playing-artwork-container-preview">
                                            <?php if (!empty($page['cover_image_url'])): ?>
                                                <img class="episode-artwork-large" id="now-playing-artwork-preview"
                                            ...
                                            <?php else: ?>
                                                <img class="episode-artwork-large" id="now-playing-artwork-preview" src=""
                                        ...
                                        <div class="progress-section-large" id="progress-section-now-playing-preview">
                                            ...
                                            <div class="progress-bar-now-playing" id="progress-bar-now-playing-preview">
                                                <div class="progress-fill-now-playing"
                                                    id="progress-fill-now-playing-preview"></div>
                                                <div class="progress-scrubber-now-playing"
                                                    id="progress-scrubber-now-playing-preview"></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="player-controls-section">
                                            <div class="primary-controls">
                                                <button class="control-button-large skip-back-large"
                                                    id="skip-back-large-preview" aria-label="Skip back 10 seconds">
                                                    <span class="skip-label-large">10</span>
                                                    <i class="fas fa-backward"></i>
                                                </button>
                                                <button class="control-button-large play-pause-large-now"
                                                    id="play-pause-large-now-preview" aria-label="Play/Pause">
                                                    <i class="fas fa-play"></i>
                                                </button>
                                                <button class="control-button-large skip-forward-large"
                                                    id="skip-forward-large-preview" aria-label="Skip forward 45 seconds">
