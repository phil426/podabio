...
<body>
    ...
    <div class="examples-page">
        ...
        <div class="placeholder-note">
            ...
            <p>We're collecting examples from our users. If you'd like to showcase your PodaBio page here, <a
                    href="/support/" style="color: #667eea;">contact us</a>!</p>
        </div>
        ...
        <div class="examples-grid">
            ...
            <div class="example-card" data-category="business">
                <div class="example-screenshot">
                    <img src="/assets/images/examples/business-podcast.png" alt="Business Podcast Example">
                </div>
                <div class="example-info">
                    <h3>Business Podcast Example</h3>
                    <p style="color: #6b7280; margin-top: 0.5rem;">Professional theme with focus on credibility and
                        trust.</p>
            ...
            <div class="example-card" data-category="comedy">
                <div class="example-screenshot">
                    <img src="/assets/images/examples/comedy-podcast.png" alt="Comedy Podcast Example">
                </div>
                <div class="example-info">
                    <h3>Comedy Podcast Example</h3>
                    <p style="color: #6b7280; margin-top: 0.5rem;">Vibrant theme that matches the podcast's personality.
                    </p>
                    <div class="example-meta">
            ...
            <div class="example-card" data-category="technology">
                <div class="example-screenshot">
                    <img src="/assets/images/examples/tech-podcast.png" alt="Technology Podcast Example">
                </div>
                <div class="example-info">
                    <h3>Technology Podcast Example</h3>
                    <p style="color: #6b7280; margin-top: 0.5rem;">Modern, minimalist design for tech-savvy audiences.
                    </p>
                    <div class="example-meta">
