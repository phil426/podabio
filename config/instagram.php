 ...
 * @return string
 * 
 * NOTE: This function is also defined in config/meta.php
 * If meta.php is loaded first, this function won't be defined (function_exists check prevents redeclaration)
 */
if (!function_exists('getInstagramAuthUrl')) {
    function getInstagramAuthUrl($mode = 'link') {
        ...
        // Load helpers for getCurrentBaseUrl() if not already loaded
 ...
 * 
 * NOTE: This function is also defined in config/meta.php
 * If meta.php is loaded first, this function won't be defined
 */
if (!function_exists('getInstagramAccessToken')) {
 ...
 * NOTE: This function is also defined in config/meta.php
 */
if (!function_exists('getInstagramLongLivedToken')) {
 ...
 * NOTE: This function is also defined in config/meta.php
 */
if (!function_exists('getInstagramUserInfo')) {
