...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $response = [
        ...
        'page' => [
            ...
            'page_background_image_url' => $userPage['page_background_image_url'] ?? null,
            'page_background_image_overlay' => $userPage['page_background_image_overlay'] ?? null,
            'page_background_image_focal_x' => $userPage['page_background_image_focal_x'] ?? null,
            'page_background_image_focal_y' => $userPage['page_background_image_focal_y'] ?? null,
            'page_background_image_scale' => isset($userPage['page_background_image_scale']) ? (float) $userPage['page_background_image_scale'] : 1.0,
            'page_background_image_blur' => $userPage['page_background_image_blur'] ?? '0px',
