...
switch ($action) {
    ...
    case 'update_appearance':
        ...
        if (isset($_POST['page_name_effect'])) {
            ...
            $validEffects = ['', 'sweet-title', 'long-shadow', '3d-extrude', 'jello', 'neon', 'gummy', 'water', 'outline', 'rainbow', 'badge-shield', 'isometric-3d', 'geometric-cutout', 'stencil', 'pattern-fill', 'depth-layers'];
